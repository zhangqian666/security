 ...
 * 
 */
package com.zq.browser.session;
...
public class AbstractSessionStrategy {
	...
	public AbstractSessionStrategy(SecurityProperties securityPropertie) {
		String invalidSessionUrl = securityPropertie.getBrowserProperties().getSession().getSessionInvalidUrl();
	...
	protected void onSessionInvalid(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (StringUtils.endsWithIgnoreCase(sourceUrl, ".html")) {
			if(StringUtils.equals(sourceUrl, securityPropertie.getBrowserProperties().getSignInPage())
					|| StringUtils.equals(sourceUrl, securityPropertie.getBrowserProperties().getSignOutUrl())){
				targetUrl = sourceUrl;
			}else{
	...
	protected Object buildResponseContent(HttpServletRequest request) {
		...
		return ServerResponse.createByError(message);
	}
